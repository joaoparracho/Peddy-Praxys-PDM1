...
import com.example.joaoparracho.peddypraxis.custommodel.CustomImageClassifierProcessor;
import com.example.joaoparracho.peddypraxis.facedetection.FaceContourDetectorProcessor;
import com.example.joaoparracho.peddypraxis.facedetection.FaceDetectionProcessor;
import com.example.joaoparracho.peddypraxis.imagelabeling.ImageLabelingProcessor;
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    mHandler = new Handler(Looper.getMainLooper()) {
      ...
      public void handleMessage(Message msg) {
        ...
        if (feedback != null) {
          Toast.makeText(LivePreviewActivity.this, feedback, Toast.LENGTH_SHORT).show();
        }
      }
    };
  }
