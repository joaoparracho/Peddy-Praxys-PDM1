 ...
 */
public class FaceGraphic extends com.example.joaoparracho.peddypraxis.common.GraphicOverlay.Graphic {
    ...
    public FaceGraphic(com.example.joaoparracho.peddypraxis.common.GraphicOverlay overlay, FirebaseVisionFace face, int facing) {
        super(overlay);
