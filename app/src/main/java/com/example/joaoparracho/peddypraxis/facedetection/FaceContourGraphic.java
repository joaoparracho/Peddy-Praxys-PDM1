...
public class FaceContourGraphic extends com.example.joaoparracho.peddypraxis.common.GraphicOverlay.Graphic {
  ...
  public FaceContourGraphic(com.example.joaoparracho.peddypraxis.common.GraphicOverlay overlay, FirebaseVisionFace face) {
    super(overlay);
