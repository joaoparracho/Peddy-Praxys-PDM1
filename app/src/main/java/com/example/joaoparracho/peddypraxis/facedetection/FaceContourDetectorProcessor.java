...
public class FaceContourDetectorProcessor extends VisionProcessorBase<List<FirebaseVisionFace>> {
    ...
    protected void onSuccess(
        ...
        for (int i = 0; i < faces.size(); ++i) {
            ...
            com.example.joaoparracho.peddypraxis.facedetection.FaceContourGraphic faceGraphic = new  com.example.joaoparracho.peddypraxis.facedetection.FaceContourGraphic(graphicOverlay, face);
